...
# UnMount
alias um="diskutil unmount ./mntpoint"
alias check_sd="mount | grep -c mntpoint"
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/Users/hkim139/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/hkim139/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/hkim139/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
